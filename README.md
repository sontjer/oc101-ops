...
When the OpenClaw Gateway crashes or loses heartbeat, watchdog sends Telegram SOS alerts with diagnostic context in 20 minutes so operators can respond quickly.
